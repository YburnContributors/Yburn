...
namespace Yburn.SingleQQ.UI
{
	public partial class SingleQQPanel : UserControl
	{
		...
		private Dictionary<string, string> GetControlsValues()
		{
			...
			nameValuePairs["AvgInvDisplacement_per_fm"] = TbxAvgInvDisplacement.Text;
			nameValuePairs["BoundMass_MeV"] = TbxBoundMass.Text;
			nameValuePairs["ColorState"] = CbxColorState.Text;
			nameValuePairs["DataFileName"] = DataFileName;
			nameValuePairs["DebyeMass_MeV"] = TbxDebyeMass.Text;
			nameValuePairs["Energy_MeV"] = TbxEnergy.Text;
			nameValuePairs["EnergyScale_MeV"] = EnergyScale;
			nameValuePairs["EnergySteps"] = TbxEnergySteps.Text;
			nameValuePairs["GammaDamp_MeV"] = TbxGammaDamp.Text;
			nameValuePairs["GammaDiss_MeV"] = TbxGammaDiss.Text;
			nameValuePairs["GammaTot_MeV"] = TbxGammaTot.Text;
			nameValuePairs["MaxEnergy_MeV"] = TbxMaxEnergy.Text;
			nameValuePairs["MaxRadius_fm"] = TbxMaxRadius.Text;
			...
			nameValuePairs["QuarkMass_MeV"] = TbxQuarkMass.Text;
			nameValuePairs["DisplacementRMS_fm"] = TbxDisplacementRMS.Text;
			...
			nameValuePairs["Sigma_MeV2"] = TbxSigma.Text;
			nameValuePairs["SigmaEff_MeV2"] = TbxSigmaEff.Text;
			nameValuePairs["SoftScale_MeV"] = TbxSoftScale.Text;
			nameValuePairs["SpinCouplingRange_fm"] = TbxSpinCouplingRange.Text;
			nameValuePairs["SpinCouplingStrength_MeV"] = TbxSpinCouplingStrength.Text;
			...
			nameValuePairs["Temperature_MeV"] = TbxTemperature.Text;
			nameValuePairs["Tchem_MeV"] = TbxTchem.Text;
			nameValuePairs["Tcrit_MeV"] = TbxTcrit.Text;
			nameValuePairs["Trials"] = TbxTrials.Text;
			nameValuePairs["UltraSoftScale_MeV"] = TbxUltraSoftScale.Text;
			nameValuePairs["UseFixedAlpha"] = ChkUseFixedAlpha.Checked.ToString();
			nameValuePairs["WaveVector_per_fm"] = TbxWaveVector.Text;
