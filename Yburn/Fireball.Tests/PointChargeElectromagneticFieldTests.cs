...
namespace Yburn.Fireball.Tests
{
	...
	public class PointChargeElectromagneticFieldTests
	{
		...
		{
			AssertHelper.AssertRoundedEqual(0.0049467209997090845, fieldValues[0, 0]);
			AssertHelper.AssertRoundedEqual(0.0059387002261759025, fieldValues[0, 1]);
			AssertHelper.AssertRoundedEqual(0.0017557690290176549, fieldValues[0, 2]);
			AssertHelper.AssertRoundedEqual(0.00014832126189119873, fieldValues[0, 3]);
			AssertHelper.AssertRoundedEqual(2.51893192097701E-05, fieldValues[0, 4]);

			AssertHelper.AssertRoundedEqual(1.1963757605413558E-05, fieldValues[1, 0]);
			AssertHelper.AssertRoundedEqual(7.5823493934334626E-08, fieldValues[1, 1]);
			AssertHelper.AssertRoundedEqual(-9.5159750512638544E-07, fieldValues[1, 2]);
			AssertHelper.AssertRoundedEqual(-1.2201623967417586E-07, fieldValues[1, 3]);
			AssertHelper.AssertRoundedEqual(-2.2138424860791441E-08, fieldValues[1, 4]);

			AssertHelper.AssertRoundedEqual(0.0049467209997090845, fieldValues[2, 0]);
			AssertHelper.AssertRoundedEqual(0.0059387002261759025, fieldValues[2, 1]);
			AssertHelper.AssertRoundedEqual(0.0017557690290176549, fieldValues[2, 2]);
			AssertHelper.AssertRoundedEqual(0.00014832126189119873, fieldValues[2, 3]);
			AssertHelper.AssertRoundedEqual(2.51893192097701E-05, fieldValues[2, 4]);
		}
		...
		private void AssertCorrectPointChargeFields_DiffusionApproximation(double[,] fieldValues)
		{
			...
			AssertHelper.AssertRoundedEqual(1.2987045736925823E-05, fieldValues[1, 0]);
			AssertHelper.AssertRoundedEqual(3.2768311031226838E-08, fieldValues[1, 1]);
			AssertHelper.AssertRoundedEqual(-9.5975204229983674E-07, fieldValues[1, 2]);
			AssertHelper.AssertRoundedEqual(-1.2207878863917365E-07, fieldValues[1, 3]);
			AssertHelper.AssertRoundedEqual(-2.2140237645729471E-08, fieldValues[1, 4]);
		...
		{
			AssertHelper.AssertRoundedEqual(0.0092479378354883117, fieldValues[0, 0]);
			AssertHelper.AssertRoundedEqual(0.00026408176571688155, fieldValues[0, 1]);
			AssertHelper.AssertRoundedEqual(1.7628840881285309E-05, fieldValues[0, 2]);
			AssertHelper.AssertRoundedEqual(2.7756673928392448E-07, fieldValues[0, 3]);
			AssertHelper.AssertRoundedEqual(1.77719066637953E-08, fieldValues[0, 4]);

			AssertHelper.AssertRoundedEqual(-0.00012497213291200423, fieldValues[1, 0]);
			AssertHelper.AssertRoundedEqual(-1.4274690038750356E-05, fieldValues[1, 1]);
			AssertHelper.AssertRoundedEqual(-2.3822757947682848E-06, fieldValues[1, 2]);
			AssertHelper.AssertRoundedEqual(-1.500360752886078E-07, fieldValues[1, 3]);
			AssertHelper.AssertRoundedEqual(-2.4016090086209862E-08, fieldValues[1, 4]);

			AssertHelper.AssertRoundedEqual(0.0092483986903891917, fieldValues[2, 0]);
			AssertHelper.AssertRoundedEqual(0.00026409492577246675, fieldValues[2, 1]);
			AssertHelper.AssertRoundedEqual(1.7629719383916E-05, fieldValues[2, 2]);
			AssertHelper.AssertRoundedEqual(2.7758057133971843E-07, fieldValues[2, 3]);
			AssertHelper.AssertRoundedEqual(1.7772792295860485E-08, fieldValues[2, 4]);
		}
	}
}