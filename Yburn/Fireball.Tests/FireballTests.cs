...
namespace Yburn.Fireball.Tests
{
    ...
    public class FireballTests
    {
        ...
        public void FireballEvolution_AveragedTemperature()
        {
            ...
            AssertHelper.AssertRoundedEqual(0.68735662437179279, qgpSuppressionFactors[(int)BottomiumState.Y1S]);
            AssertHelper.AssertRoundedEqual(0.14694835740182993, qgpSuppressionFactors[(int)BottomiumState.x1P]);
            AssertHelper.AssertRoundedEqual(0.18302631965025359, qgpSuppressionFactors[(int)BottomiumState.Y2S]);
        ...
        public void FireballEvolution_MaximallyBlueshifted()
        {
            ...
            AssertHelper.AssertRoundedEqual(0.0211150172373465, qgpSuppressionFactors[(int)BottomiumState.x1P]);
            AssertHelper.AssertRoundedEqual(0.029253999794419144, qgpSuppressionFactors[(int)BottomiumState.Y2S]);
            AssertHelper.AssertRoundedEqual(0.0085912564231609024, qgpSuppressionFactors[(int)BottomiumState.x2P]);
