...
{
	public partial class InMediumDecayWidthMainWindow : Form
	{
		/********************************************************************************************
		 * Constructors
		 ********************************************************************************************/
		...
		private void MenuItemLoadBatchFile_Click(object sender, EventArgs e)
		{
			...
			if(dialog.ShowDialog() == DialogResult.OK)
			{
				JobOrganizer.ProcessBatchFile(dialog.FileName, InMediumDecayWidthPanel.ControlsValues);
			}
		}
		...
		{
			InMediumDecayWidthPanel.ControlsValues = JobOrganizer.GetDataFromWorker();
		}
