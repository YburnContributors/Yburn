...
{
	public partial class ElectromagnetismMainWindow : Form
	{
		/********************************************************************************************
		 * Constructors
		 ********************************************************************************************/

		public ElectromagnetismMainWindow(
			string title,
		...
		{
			this.Text = title;
			MenuStrip.Items.Add(ElectromagnetismPanel.MenuEntry);
		}
		...
		private void MenuItemLoadBatchFile_Click(object sender, EventArgs e)
		{
			...
			if(dialog.ShowDialog() == DialogResult.OK)
			{
				JobOrganizer.ProcessBatchFile(dialog.FileName, ElectromagnetismPanel.ControlsValues);
			}
		}
		...
		{
			ElectromagnetismPanel.ControlsValues = JobOrganizer.GetDataFromWorker();
		}
		...
		private void MenutItemSaveValuesAsParameterFile_Click(object sender, EventArgs e)
		{
			using(SaveFileDialog dialog = SaveAsParaFileDialog.Create())
			{
				if(dialog.ShowDialog() == DialogResult.OK)
				{
					JobOrganizer.SaveAsParameterFile(dialog.FileName,
						ElectromagnetismPanel.ControlsValues);
				}
			}
		}
