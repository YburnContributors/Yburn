namespace Yburn.SingleQQ
{
	partial class AlphaPlotParamForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.MsxRunningCouplingType = new UI.MultiSelectBox();
			...
			this.LblRunningCouplingType.TabIndex = 14;
		...
		private UI.MultiSelectBox MsxRunningCouplingType;
	}
}