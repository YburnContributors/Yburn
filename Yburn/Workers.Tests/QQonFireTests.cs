...
namespace Yburn.Workers.Tests
{
    ...
    public class QQonFireTests : QQonFire
    {
            ...
            )
        {
            ...
            AssertHelper.AssertRoundedEqual(0.19254878741653947, suppressionFactors[0][0][0][(int)BottomiumState.Y2S]);
            ...
            AssertHelper.AssertRoundedEqual(0.7323105191725604, suppressionFactors[0][2][0][(int)BottomiumState.Y1S]);
            ...
            AssertHelper.AssertRoundedEqual(0.77665332129383058, suppressionFactors[1][0][0][(int)BottomiumState.Y1S]);
            ...
            )
        {
            ...
            AssertHelper.AssertRoundedEqual(0.32141783212834024, suppressionFactors[0][4][0][(int)BottomiumState.x1P]);
