...
namespace Yburn.Workers
{
	partial class SingleQQ
	{
		...
		protected override Dictionary<string, string> GetVariableNameValuePairs()
		{
			...
			Store(nameValuePairs, "AvgInvDisplacement", AvgInvDisplacement);
			...
			Store(nameValuePairs, "DisplacementRMS", DisplacementRMS);
		   ...
		   )
		{
			...
			TryExtract(nameValuePairs, "AvgInvDisplacement", ref AvgInvDisplacement);
			...
			TryExtract(nameValuePairs, "DisplacementRMS", ref DisplacementRMS);
		...
		private double AvgInvDisplacement;
		...
		private double DisplacementRMS;
